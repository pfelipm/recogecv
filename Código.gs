...
function doGet(e) {
  ...
  return formularioWeb.evaluate().setTitle(hdc.getRange(TITULO).getValue()).setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
